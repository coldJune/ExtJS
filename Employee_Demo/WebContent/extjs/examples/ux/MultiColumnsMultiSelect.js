 ...
 * @xtype multiselect
 */
Ext.ux.form.MultiColumnsMultiSelect = Ext.extend(Ext.form.Field,  {
    /**
    ...
    initComponent: function(){
        Ext.ux.form.MultiColumnsMultiSelect.superclass.initComponent.call(this);
    ...
    onRender: function(ct, position){
        Ext.ux.form.MultiColumnsMultiSelect.superclass.onRender.call(this, ct, position);
    ...
    afterRender: function(){
        Ext.ux.form.MultiColumnsMultiSelect.superclass.afterRender.call(this);
        ...
        if (this.draggable || this.dragGroup){
            this.dragZone = new Ext.ux.form.MultiColumnsMultiSelect.DragZone(this, {
                ddGroup: this.dragGroup
            });
        }
        if (this.droppable || this.dropGroup){
            this.dropZone = new Ext.ux.form.MultiColumnsMultiSelect.DropZone(this, {
     ...
     */
    getValue: function(){
        var selectionsArray = this.view.getSelectedRecords();
    ...
    setValue: function(values) {
        ...
        if (!Ext.isArray(values)) { return;}
        this.view.store.add(values)
        this.view.select(values);
        this.hiddenField.dom.value = this.getValue();
        this.validate();
    },
...
//        return true;
    ...
    destroy: function(){
        ...
        Ext.ux.form.MultiColumnsMultiSelect.superclass.destroy.call(this);
    }
});


Ext.reg('multiselect', Ext.ux.form.MultiColumnsMultiSelect);

//backwards compat
Ext.ux.MultiColumnsMultiSelect = Ext.ux.form.MultiColumnsMultiSelect;


Ext.ux.form.MultiColumnsMultiSelect.DragZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    ...
    Ext.ux.form.MultiColumnsMultiSelect.DragZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDraggable(ddGroup);
};

Ext.extend(Ext.ux.form.MultiColumnsMultiSelect.DragZone, Ext.dd.DragZone, {
...
Ext.ux.form.MultiColumnsMultiSelect.DropZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    var ddGroup = config.ddGroup || 'MultiselectDD';
    var dd;
    ...
    Ext.ux.form.MultiColumnsMultiSelect.DropZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDroppable(ddGroup);
};

Ext.extend(Ext.ux.form.MultiColumnsMultiSelect.DropZone, Ext.dd.DropZone, {
    /**
